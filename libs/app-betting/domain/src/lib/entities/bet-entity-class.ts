import {BetTypeInfo, IBetEntity, Runner} from "./bet-entity-interface";

export class BetEntity implements IBetEntity {
  ...
  public betTypeInfos: BetTypeInfo[];
  ...
  constructor(init?: Partial<BetEntity>) {
